...
enum TokenKind : u8 {
    ...
    TK_FUN, TK_VAR, TK_TYPE, TK_CASE, TK_MATCH, TK_ALIAS, TK_MODULE, TK_NEW, TK_DEL, TK_DO, TK_THEN, TK_BREAK, TK_CONTINUE,
...
static constexpr const i8* KEYWORD_STRINGS[TK_LAST_KEYWORD - TK_FIRST_KEYWORD] = {
    ...
    "fun", "var", "type", "case", "match", "alias", "module", "new", "del", "do", "then", "break", "continue",
    "true", "false"
};
