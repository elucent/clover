...
enum TokenKind : u8 {
    ...
    TK_IF, TK_ELSE, TK_WHILE, TK_UNTIL, TK_WITH, TK_FOR, TK_IN, TK_USE, TK_RETURN, TK_DEFER, TK_AS, 
    TK_FUN, TK_VAR, TK_TYPE, TK_CASE, TK_MATCH, TK_ALIAS, TK_MODULE, TK_NEW, TK_DO, TK_THEN, TK_BREAK, TK_CONTINUE,
...
static constexpr const i8* KEYWORD_STRINGS[TK_LAST_KEYWORD - TK_FIRST_KEYWORD] = {
    "and", "or", "not", 
    "if", "else", "while", "until", "with", "for", "in", "use", "return", "defer", "as", 
    "fun", "var", "type", "case", "match", "alias", "module", "new", "do", "then", "break", "continue",
    "true", "false"
};
...
static constexpr const i8 PRECEDENCE[NUM_TOKEN_KINDS] = {
    ...
    PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE,
    PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE, PREC_NONE,
    PREC_NONE, PREC_NONE,
