...
CLOVER_CLRT_CXX_SOURCES := $(wildcard $(CLOVER_SRC_ROOT)/std/*.cpp)
...
CLOVER_STD_CL_SOURCES := $(wildcard $(CLOVER_SRC_ROOT)/std/*.cl)
CLOVER_STD_DEBUG_PRODUCTS := $(wildcard $(CLOVER_STD_CL_SOURCES:%.cl=$(DEBUG_BUILD)/%.cl))
CLOVER_STD_RELEASE_PRODUCTS := $(wildcard $(CLOVER_STD_CL_SOURCES:%.cl=$(RELEASE_BUILD)/%.cl))
