...
namespace clover {
    ...
    struct Module : public ArtifactData {
        ...
        // Populated after memory analysis pass, tracks which type indices we
        // call a constructor/destructor for, so that during code generation we
        // can lazily generate any that weren't generated by another module in
        // this compilation.
        biasedset<256> needsConstructor, needsDestructor, constructorDestructorInited;
