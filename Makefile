...
libclrt.a-debug: $(DEBUG_MANIFEST) $(RT_DEBUG_HEADERS) $(UTIL_DEBUG_HEADERS) $(ASM_DEBUG_HEADERS) $(JASMINE_DEBUG_HEADERS) $(CLOVER_DEBUG_HEADERS) $(RT_DEBUG_OBJS) $(DEBUG_BUILD)/util/init.o $(DEBUG_BUILD)/util/io.o $(DEBUG_BUILD)/util/elumalloc.o $(DEBUG_BUILD)/clover/clrt/clrt.o
	ar -rcs $(DEBUG_BUILD)/libclrt.a $(RT_DEBUG_OBJS) $(DEBUG_BUILD)/util/init.o $(DEBUG_BUILD)/util/io.o $(DEBUG_BUILD)/util/elumalloc.o $(DEBUG_BUILD)/clover/clrt/clrt.o

libclrt.a-release: $(RELEASE_MANIFEST) $(RT_RELEASE_HEADERS) $(UTIL_RELEASE_HEADERS) $(ASM_RELEASE_HEADERS) $(JASMINE_RELEASE_HEADERS) $(CLOVER_RELEASE_HEADERS) $(RT_RELEASE_OBJS) $(RELEASE_BUILD)/util/init.o $(RELEASE_BUILD)/util/io.o $(RELEASE_BUILD)/util/elumalloc.o $(RELEASE_BUILD)/clover/clrt/clrt.o
	ar -rcs $(RELEASE_BUILD)/libclrt.a $(RT_RELEASE_OBJS) $(RELEASE_BUILD)/util/init.o $(RELEASE_BUILD)/util/io.o $(RELEASE_BUILD)/util/elumalloc.o $(RELEASE_BUILD)/clover/clrt/clrt.o
