...
test-clover-debug: $(DEBUG_MANIFEST) $(RT_DEBUG_HEADERS) $(UTIL_DEBUG_HEADERS) $(ASM_DEBUG_HEADERS) $(JASMINE_DEBUG_HEADERS) $(CLOVER_DEBUG_HEADERS) $(RT_DEBUG_OBJS) $(UTIL_DEBUG_OBJS) $(ASM_DEBUG_OBJS) $(JASMINE_DEBUG_OBJS) $(CLOVER_DEBUG_OBJS) $(JASMINE_DEBUG_RULES_OBJ) $(TEST_HARNESS_DEBUG_OBJS) $(CLOVER_TEST_DEBUG_OBJS) $(RT_ENTRY_DEBUG_OBJS) clover-source-tests.cpp clover-debug
	cat $(RT_DEBUG_DEPFILES) $(UTIL_DEBUG_DEPFILES) $(ASM_DEBUG_DEPFILES) $(JASMINE_DEBUG_DEPFILES) $(CLOVER_DEBUG_DEPFILES) > $(DEBUG_DEPFILE)
