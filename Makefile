...
CLOVER_PATH := clover
GEN_SRCTESTS := clover/test/gen-srctests
...
libclrt.a-debug: $(DEBUG_MANIFEST) $(RT_DEBUG_HEADERS) $(UTIL_DEBUG_HEADERS) $(ASM_DEBUG_HEADERS) $(JASMINE_DEBUG_HEADERS) $(CLOVER_DEBUG_HEADERS) $(RT_DEBUG_OBJS) $(DEBUG_BUILD)/util/init.o $(DEBUG_BUILD)/util/io.o $(DEBUG_BUILD)/util/elumalloc.o $(DEBUG_BUILD)/clover/std/clrt.o
	ar -rcs $(DEBUG_BUILD)/$(CLOVER_PATH)/libclrt.a $(RT_DEBUG_OBJS) $(DEBUG_BUILD)/util/init.o $(DEBUG_BUILD)/util/io.o $(DEBUG_BUILD)/util/elumalloc.o $(DEBUG_BUILD)/clover/std/clrt.o
...
libclrt.a-release: $(RELEASE_MANIFEST) $(RT_RELEASE_HEADERS) $(UTIL_RELEASE_HEADERS) $(ASM_RELEASE_HEADERS) $(JASMINE_RELEASE_HEADERS) $(CLOVER_RELEASE_HEADERS) $(RT_RELEASE_OBJS) $(RELEASE_BUILD)/util/init.o $(RELEASE_BUILD)/util/io.o $(RELEASE_BUILD)/util/elumalloc.o $(RELEASE_BUILD)/clover/std/clrt.o
	ar -rcs $(RELEASE_BUILD)/$(CLOVER_PATH)/libclrt.a $(RT_RELEASE_OBJS) $(RELEASE_BUILD)/util/init.o $(RELEASE_BUILD)/util/io.o $(RELEASE_BUILD)/util/elumalloc.o $(RELEASE_BUILD)/clover/std/clrt.o

libsrctest.a-debug: $(DEBUG_MANIFEST) $(RT_DEBUG_HEADERS) $(UTIL_DEBUG_HEADERS) $(RT_DEBUG_OBJS) $(DEBUG_BUILD)/util/init.o $(DEBUG_BUILD)/util/io.o $(DEBUG_BUILD)/util/elumalloc.o $(DEBUG_BUILD)/util/utf.o $(DEBUG_BUILD)/clover/test/libsrctest.o
	ar -rcs $(DEBUG_BUILD)/$(CLOVER_PATH)/libsrctest.a $(RT_DEBUG_OBJS) $(DEBUG_BUILD)/util/init.o $(DEBUG_BUILD)/util/io.o $(DEBUG_BUILD)/util/elumalloc.o $(DEBUG_BUILD)/util/utf.o $(DEBUG_BUILD)/clover/test/libsrctest.o

libsrctest.a-release: $(RELEASE_MANIFEST) $(RT_RELEASE_HEADERS) $(UTIL_RELEASE_HEADERS) $(RT_RELEASE_OBJS) $(RELEASE_BUILD)/util/init.o $(RELEASE_BUILD)/util/io.o $(RELEASE_BUILD)/util/elumalloc.o $(RELEASE_BUILD)/util/utf.o $(RELEASE_BUILD)/clover/test/libsrctest.o
	ar -rcs $(RELEASE_BUILD)/$(CLOVER_PATH)/libsrctest.a $(RT_RELEASE_OBJS) $(RELEASE_BUILD)/util/init.o $(RELEASE_BUILD)/util/io.o $(RELEASE_BUILD)/util/elumalloc.o $(RELEASE_BUILD)/util/utf.o $(RELEASE_BUILD)/clover/test/libsrctest.o
...
$(DEBUG_BUILD)/clover/test/clover-srctests.o: $(GEN_SRCTESTS) $(DEBUG_MANIFEST) $(CLOVER_SRC_TESTS)
	$(GEN_SRCTESTS) $(CLOVER_SRC_TESTS) $(DEBUG_BUILD)/clover/test
	$(CXX_COMPILE_DEBUG) $@ $(@:.o=.cpp)

$(RELEASE_BUILD)/clover/test/clover-srctests.o: $(GEN_SRCTESTS) $(RELEASE_MANIFEST) $(CLOVER_SRC_TESTS)
	$(GEN_SRCTESTS) $(CLOVER_SRC_TESTS) $(RELEASE_BUILD)/clover/test
	$(CXX_COMPILE_RELEASE) $@ $(@:.o=.cpp)

test-clover-debug: $(DEBUG_MANIFEST) $(RT_DEBUG_HEADERS) $(UTIL_DEBUG_HEADERS) $(ASM_DEBUG_HEADERS) $(JASMINE_DEBUG_HEADERS) $(CLOVER_DEBUG_HEADERS) $(RT_DEBUG_OBJS) $(UTIL_DEBUG_OBJS) $(ASM_DEBUG_OBJS) $(JASMINE_DEBUG_OBJS) $(CLOVER_DEBUG_OBJS) $(JASMINE_DEBUG_RULES_OBJ) $(TEST_HARNESS_DEBUG_OBJS) $(CLOVER_TEST_DEBUG_OBJS) $(RT_ENTRY_DEBUG_OBJS) libsrctest.a-debug clover-debug $(DEBUG_BUILD)/clover/test/clover-srctests.o
	cat $(RT_DEBUG_DEPFILES) $(UTIL_DEBUG_DEPFILES) $(ASM_DEBUG_DEPFILES) $(JASMINE_DEBUG_DEPFILES) $(CLOVER_DEBUG_DEPFILES) > $(DEBUG_DEPFILE)
	$(LINK_TESTS) $(DEBUG_BUILD)/test-clover.cpp $(CLOVER_TEST_DEBUG_OBJS) $(DEBUG_BUILD)/clover/test/clover-srctests.o
	$(CXX_LINK_EXECUTABLE_DEBUG) $(DEBUG_BUILD)/test-clover $(DEBUG_BUILD)/test-clover.cpp $(RT_DEBUG_OBJS) $(UTIL_DEBUG_OBJS) $(ASM_DEBUG_OBJS) $(JASMINE_DEBUG_OBJS) $(CLOVER_DEBUG_OBJS) $(JASMINE_DEBUG_RULES_OBJ) $(TEST_HARNESS_DEBUG_OBJS) $(CLOVER_TEST_DEBUG_OBJS) $(RT_ENTRY_DEBUG_OBJS) $(DEBUG_BUILD)/clover/test/clover-srctests.o

test-clover-release: $(RELEASE_MANIFEST) $(RT_RELEASE_HEADERS) $(UTIL_RELEASE_HEADERS) $(ASM_RELEASE_HEADERS) $(JASMINE_RELEASE_HEADERS) $(CLOVER_RELEASE_HEADERS) $(RT_RELEASE_OBJS) $(UTIL_RELEASE_OBJS) $(ASM_RELEASE_OBJS) $(JASMINE_RELEASE_OBJS) $(CLOVER_RELEASE_OBJS) $(JASMINE_RELEASE_RULES_OBJ) $(TEST_HARNESS_RELEASE_OBJS) $(CLOVER_TEST_RELEASE_OBJS) $(RT_ENTRY_RELEASE_OBJS) libsrctest.a-release clover-release $(RELEASE_BUILD)/clover/test/clover-srctests.o
	cat $(RT_RELEASE_DEPFILES) $(UTIL_RELEASE_DEPFILES) $(ASM_RELEASE_DEPFILES) $(JASMINE_RELEASE_DEPFILES) $(CLOVER_RELEASE_DEPFILES) > $(RELEASE_DEPFILE)
	$(LINK_TESTS) $(RELEASE_BUILD)/test-clover.cpp $(CLOVER_TEST_RELEASE_OBJS) $(RELEASE_BUILD)/clover/test/clover-srctests.o
	$(CXX_LINK_EXECUTABLE_RELEASE) $(RELEASE_BUILD)/test-clover $(RELEASE_BUILD)/test-clover.cpp $(RT_RELEASE_OBJS) $(UTIL_RELEASE_OBJS) $(ASM_RELEASE_OBJS) $(JASMINE_RELEASE_OBJS) $(CLOVER_RELEASE_OBJS) $(JASMINE_RELEASE_RULES_OBJ) $(TEST_HARNESS_RELEASE_OBJS) $(CLOVER_TEST_RELEASE_OBJS) $(RT_ENTRY_RELEASE_OBJS) $(RELEASE_BUILD)/clover/test/clover-srctests.o
