...
RT_CXX_HEADERS := $(wildcard $(RT_SRC_ROOT)/*.h)
RT_CXX_SOURCES := $(wildcard $(RT_SRC_ROOT)/*.cpp)
...
# Consider uncommenting these if we re-enable support for freestanding builds.
#
...
RT_DIRS_DEBUG := \
	$(DEBUG_BUILD)/$(RT_SRC_ROOT) \
	$(DEBUG_BUILD)/include/$(RT_SRC_ROOT)
RT_DIRS_RELEASE := \
