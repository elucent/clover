...
static constexpr const range control_chars[] = { //  Cc
	{ 0x0, 0x1f }, // Basic Latin
	{ 0x7f, 0x9f }
};

static constexpr const range format_chars[] = { //  Cf
	{ 0xad, 0xad },
	{ 0x600, 0x605 }, // Arabic
	{ 0x61c, 0x61c },
	{ 0x6dd, 0x6dd },
...
static constexpr const range private_use_chars[] = { //  Co
	{ 0xe000, 0xe000 },
	{ 0xf8ff, 0xf8ff },
	{ 0xf0000, 0xf0000 },
	{ 0xffffd, 0xffffd },
...
static constexpr const range surrogate_chars[] = { //  Cs
	{ 0xd800, 0xd800 },
	{ 0xdb7f, 0xdb80 },
	{ 0xdbff, 0xdc00 },
	{ 0xdfff, 0xdfff }
...
static constexpr const range lowercase_letters[] = { //  Ll
	{ 0x61, 0x7a },
	{ 0xb5, 0xb5 },
	{ 0xdf, 0xf6 },
	{ 0xf8, 0xff },
...
static constexpr const range letter_modifiers[] = { //  Lm
...
static constexpr const range other_letters[] = { //  Lo
	{ 0xaa, 0xaa },
	{ 0xba, 0xba },
	{ 0x1bb, 0x1bb },
	{ 0x1c0, 0x1c3 },
...
static constexpr const range titlecase_letters[] = { //  Lt
	{ 0x1c5, 0x1c5 },
	{ 0x1c8, 0x1c8 },
	{ 0x1cb, 0x1cb },
	{ 0x1f2, 0x1f2 },
...
static constexpr const range uppercase_letters[] = { //  Lu
	{ 0x41, 0x5a },
	{ 0xc0, 0xd6 },
	{ 0xd8, 0xde },
...
static constexpr const range spacing_combining_marks[] = { //  Mc
...
static constexpr const range enclosing_marks[] = { //  Me
	{ 0x488, 0x489 },
	{ 0x1abe, 0x1abe },
	{ 0x20dd, 0x20e0 },
	{ 0x20e2, 0x20e4 },
...
static constexpr const range nonspacing_marks[] = { //  Mn
...
static constexpr const range decimal_digits[] = { //  Nd
	{ 0x30, 0x39 },
	{ 0x660, 0x669 },
	{ 0x6f0, 0x6f9 },
	{ 0x7c0, 0x7c9 }, // NKo
...
static constexpr const range letter_numbers[] = { //  Nl
	{ 0x16ee, 0x16f0 },
	{ 0x2160, 0x2182 },
	{ 0x2185, 0x2188 },
	{ 0x3007, 0x3007 },
...
static constexpr const range other_numbers[] = { //  No
	{ 0xb2, 0xb3 },
	{ 0xb9, 0xb9 },
	{ 0xbc, 0xbe },
	{ 0x9f4, 0x9f9 },
...
static constexpr const range punctuation_connectors[] = { //  Pc
	{ 0x5f, 0x5f },
	{ 0x203f, 0x2040 },
	{ 0x2054, 0x2054 },
	{ 0xfe33, 0xfe34 },
...
static constexpr const range dashes[] = { //  Pd
	{ 0x2d, 0x2d },
	{ 0x58a, 0x58a },
	{ 0x5be, 0x5be },
...
static constexpr const range punctuation_closes[] = { //  Pe
	{ 0x29, 0x29 },
	{ 0x5d, 0x5d },
	{ 0x7d, 0x7d },
...
static constexpr const range final_quotes[] = { //  Pf
	{ 0xbb, 0xbb },
	{ 0x2019, 0x2019 },
	{ 0x201d, 0x201d },
	{ 0x203a, 0x203a },
...
static constexpr const range initial_quotes[] = { //  Pi
	{ 0xab, 0xab },
	{ 0x2018, 0x2018 },
	{ 0x201b, 0x201c },
	{ 0x201f, 0x201f },
...
static constexpr const range other_punctuation[] = { //  Po
	{ 0x21, 0x23 },
	{ 0x25, 0x27 },
...
static constexpr const range punctuation_opens[] = { //  Ps
	{ 0x28, 0x28 },
	{ 0x5b, 0x5b },
	{ 0x7b, 0x7b },
...
static constexpr const range currency_symbols[] = { //  Sc
	{ 0x24, 0x24 },
	{ 0xa2, 0xa5 },
	{ 0x58f, 0x58f },
	{ 0x60b, 0x60b },
...
static constexpr const range modifier_symbols[] = { //  Sk
...
static constexpr const range math_symbols[] = { //  Sm
	{ 0x2b, 0x2b },
	{ 0x3c, 0x3e },
...
static constexpr const range other_symbols[] = { //  So
	{ 0xa6, 0xa6 },
	{ 0xa9, 0xa9 },
...
static constexpr const range line_separators[] = { //  Zl
	{ 0x2028, 0x2028 }
};

static constexpr const range paragraph_separators[] = { //  Zp
	{ 0x2029, 0x2029 }
};

static constexpr const range spaces[] = { //  Zs
	{ 0x20, 0x20 },
...
static constexpr const range other_chars[] = { //  C
	{ 0x0, 0x1f },
	{ 0x7f, 0x9f },
	{ 0xad, 0xad },
	{ 0x600, 0x605 },
...
static constexpr const range letters[] = { //  L
	{ 0x41, 0x5a },
	{ 0x61, 0x7a },
	{ 0xaa, 0xaa },
	{ 0xb5, 0xb5 },
...
static constexpr const range marks[] = { //  M
	{ 0x300, 0x36f },
	{ 0x483, 0x489 },
	{ 0x591, 0x5bd },
	{ 0x5bf, 0x5bf },
...
static constexpr const range numbers[] = { //  N
	{ 0x30, 0x39 },
	{ 0xb2, 0xb3 },
	{ 0xb9, 0xb9 },
	{ 0xbc, 0xbe },
...
static constexpr const range punctuation[] = { //  P
	{ 0x21, 0x23 },
	{ 0x25, 0x2a },
	{ 0x2c, 0x2f },
	{ 0x3a, 0x3b },
...
static constexpr const range symbols[] = { //  S
	{ 0x24, 0x24 },
	{ 0x2b, 0x2b },
	{ 0x3c, 0x3e },
	{ 0x5e | EVEN_BIT, 0x60 | EVEN_BIT },
...
static constexpr const range separators[] = { //  Z
	{ 0x20, 0x20 },
	{ 0xa0, 0xa0 },
	{ 0x1680, 0x1680 },
	{ 0x2000, 0x200a },
...
static constexpr const range * const specific_categories[] = {
    0, // invalid
